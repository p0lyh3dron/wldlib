...
typedef struct {
    ...
    unsigned char ftw;
    unsigned char tenth;
    unsigned char dont_starve;
    unsigned char bees;
    unsigned char remix;
    unsigned char no_traps;
    ...
    unsigned char after_doom_party;
    int           invasion_delay;
    int           invasion_size;
    int           invasion_type;
    double        invasion_x;
    ...
    unsigned char kill_deer;
    unsigned char blue_slime;
    unsigned char unlocked_merchant;
    unsigned char unlocked_demo;
    unsigned char unlocked_party;
    unsigned char unlocked_dye;
    unsigned char unlocked_truffle;
    unsigned char unlocked_arms_dealer;
    unsigned char unlocked_nurse;
    unsigned char unlocked_princess;
    unsigned char combat_book_2;
    unsigned char peddler_satchel;
    unsigned char green_slime;
    unsigned char old_slime;
    unsigned char purple_slime;
    unsigned char rainbow_slime;
    unsigned char red_slime;
    unsigned char yellow_slime;
    unsigned char copper_slime;
    unsigned char moondial_active;
    unsigned char moondial_cooldown;
} wld_header_t;